...
<body class='typical-page advertising'>
  <nav class="nav-main">
      <ul class="nav">
          <li><a href="company-descr">Who we are</a></li>
      ...
      <ul class="mobile-nav">
          ...
          <li class="lang">
              <a href="#" class="active">English</a> <span class="divide">/</span> Arabic
          </li>
      </ul>
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-3 col-md-offset-2 col-sm-4 mob-to-burger">
                  <div class="lang">
                      <a href="#" class="active">English</a> <span class="divide"></span> <a href="#">Arabic</a>
                  </div>
              </div>
          </div>
          <button class="burger">
      ...
      <div class='container'>
        ...
        <div class='row'>
          ...
          <div class='col-md-4 col-md-offset-1'>
            ...
            <button class="btn btn-dashed opacity"> Connect </button>
          </div>
          <!-- /Right-main -->
        </div>
      </div>
