                ...
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/strategy" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/branding" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/design" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/mobile-marketing" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/seo" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/smm" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/mail-marketing" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="comp-block">
                        ...
                        <p class="comp-descr-hide">
                            ...
                            <a href="/advertising" class="comp-more"><?php print t('learn more');?></a>
                        </p>
                    </div>
                </div>
            </div>
